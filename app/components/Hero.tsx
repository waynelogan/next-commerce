...
export default async function Hero() {
    ...
    return (
        <section className='mx-auto max-w-2xl px-4 sm:pb-6 lg:max-w-7xl lg:px-24'>
            <div className='mb-8 flex flex-wrap justify-between md:mb-16'>
                <div className="mb-6 w-full flex flex-col justify-start sm:mb-12 lg:mb-0 lg:w-1/3 lg:pb-24 lg:pt-20">
                    <h1 className='mb-4 text-4xl text-black sm:text-5xl md:mb-8 md:text-6xl'>
                ...
                <div className='mb-12 flex w-full md:mb-16 lg:w-2/3 h-[70vmin]'>
            ...
            <div className='flex flex-col items-center justify-between gap-8 md:flex-row lg:-mt-36'>
